...
REM
REM Generated by Vivado on Sat Mar 21 01:45:20 +0530 2026
...
echo "xvlog --incr --relax -prj AHB_to_APB_Bridge_tb_vlog.prj"
call xvlog  --incr --relax -prj AHB_to_APB_Bridge_tb_vlog.prj -log xvlog.log
